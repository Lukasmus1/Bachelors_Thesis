    ...
    public class ScreenshotChoice : IChoice
    {
        public List<ChoiceActionClass> Actions { get; set; } = new()
        {
            new ChoiceActionClass(
                ...
                () =>
                {
                    UserMvc.Instance.UserController.IncreaseCuratorAlignment(Alignment.CuratorFirstChoice);
            ...
            new ChoiceActionClass(
                ...
                () =>
                {
                    UserMvc.Instance.UserController.IncreaseCuratorAlignment(Alignment.AIFirstChoice);
